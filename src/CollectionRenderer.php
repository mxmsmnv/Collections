...
class CollectionRenderer
{
    ...
    public function renderRow($page): string
    {
        ...
        // Only show View link for non-admin, non-root pages that have a real URL and a template view file
        $showViewLink = $viewUrl && $viewUrl !== '/' && $page->template->name !== 'admin' && $page->viewable();
